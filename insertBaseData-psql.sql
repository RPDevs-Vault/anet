...
-- Skip eventTypes, as these are inserted by the migrations
...
-- Create people
INSERT INTO people (uuid, "familyName", "givenName", status, "phoneNumber", rank, biography, "user", "countryUuid", gender, "endOfTourDate", "createdAt", "updatedAt") VALUES
-- Advisors
...
WHERE uuid='3cb2076c-5317-47fe-86ad-76f298993917';
...
WHERE uuid='c725aef3-cdd1-4baf-ac72-f28219b234e9';
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'EF 6 Approver'), 'c033862b-a4ef-4043-acd5-a2b399a10f00', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = 'c033862b-a4ef-4043-acd5-a2b399a10f00' WHERE name = 'EF 6 Approver';

-- Put Ben Rogers into the EF 6.1 Advisor
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'EF 6.1 Advisor'), 'c71f707a-667f-4713-9552-8510d69a308b', '2020-01-01');
UPDATE positions SET "currentPersonUuid" =  'c71f707a-667f-4713-9552-8510d69a308b' WHERE name = 'EF 6.1 Advisor';
...
-- Create some tasks
INSERT INTO tasks (uuid, "shortName", "longName", status, selectable, category, "createdAt", "updatedAt", "parentTaskUuid") VALUES
  (N'1145e584-4485-4ce0-89c4-2fa2e1fe846a', 'EF 1', 'Budget and Planning', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'fdf107e7-a88a-4dc4-b744-748e9aaffabc', '1.1', 'Budgeting in the MoD', 0, TRUE, 'Sub-EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'1145e584-4485-4ce0-89c4-2fa2e1fe846a'),
  (N'7b2ad5c3-018b-48f5-b679-61fbbda21693', '1.1.A', 'Milestone the First in EF 1.1', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'fdf107e7-a88a-4dc4-b744-748e9aaffabc'),
  (N'1b5eb36b-456c-46b7-ae9e-1c89e9075292', '1.1.B', 'Milestone the Second in EF 1.1', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'fdf107e7-a88a-4dc4-b744-748e9aaffabc'),
  (N'7fdef880-1bf3-4e56-8476-79166324023f', '1.1.C', 'Milestone the Third in EF 1.1', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'fdf107e7-a88a-4dc4-b744-748e9aaffabc'),
  (N'fe6b6b2f-d2a1-4ce1-9aa7-05361812a4d0', 'EF 1.2', 'Budgeting in the MoI', 0, TRUE, 'Sub-EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'1145e584-4485-4ce0-89c4-2fa2e1fe846a'),
  (N'ac466253-1456-4fc8-9b14-a3643746e5a6', 'EF 1.3', 'Budgeting in the Police?', 0, TRUE, 'Sub-EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'1145e584-4485-4ce0-89c4-2fa2e1fe846a'),
  (N'953e0b0b-25e6-44b6-bc77-ef98251d046a', '1.2.A', 'Milestone the First in EF 1.2', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'fe6b6b2f-d2a1-4ce1-9aa7-05361812a4d0'),
  (N'9d3da7f4-8266-47af-b518-995f587250c9', '1.2.B', 'Milestone the Second in EF 1.2', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'fe6b6b2f-d2a1-4ce1-9aa7-05361812a4d0'),
  (N'6bbb1be9-4655-48d7-83f2-bc474781544a', '1.2.C', 'Milestone the Third in EF 1.2', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'fe6b6b2f-d2a1-4ce1-9aa7-05361812a4d0'),
  (N'076793eb-9950-4ea6-bbd5-2d8b8827828c', '1.3.A', 'Getting a budget in place', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'ac466253-1456-4fc8-9b14-a3643746e5a6'),
  (N'30bc5708-c12d-4a21-916c-5acd7f6f11da', '1.3.B', 'Tracking your expenses', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'ac466253-1456-4fc8-9b14-a3643746e5a6'),
  (N'df920c99-10ea-44e8-940f-cb1d1cbd22da', '1.3.C', 'Knowing when you run out of money', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'ac466253-1456-4fc8-9b14-a3643746e5a6'),
  (N'cd35abe7-a5c9-4b3e-885b-4c72bf564ed7', 'EF 2', 'Transparency, Accountability, O (TAO)', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'75d4009d-7c79-42e0-aa2f-d79d158ec8d6', '2.A', 'This is the first Milestone in EF 2', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'cd35abe7-a5c9-4b3e-885b-4c72bf564ed7'),
  (N'2200a820-c4c7-4c9c-946c-f0c9c9e045c5', '2.B', 'This is the second Milestone in EF 2', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'cd35abe7-a5c9-4b3e-885b-4c72bf564ed7'),
  (N'0701a964-5d79-4090-8f35-a40856556675', '2.C', 'This is the third Milestone in EF 2', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'cd35abe7-a5c9-4b3e-885b-4c72bf564ed7'),
  (N'42afd501-1a2c-4758-9da5-f996b2c97156', '2.D', 'Keep track of the petty cash drawer', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'cd35abe7-a5c9-4b3e-885b-4c72bf564ed7'),
  (N'44089923-7367-4e97-82c3-dfe6b270d493', 'EF 3', 'Rule of Law', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'39d0c437-720c-4d78-8768-7f3dee5b3cd0', '3.a', 'Get some Lawyers to read a book', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'44089923-7367-4e97-82c3-dfe6b270d493'),
  (N'a710a076-be5c-4982-b870-50dd5d340eb3', '3.b', 'Get some Lawyers to wear a suit to court', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'44089923-7367-4e97-82c3-dfe6b270d493'),
  (N'c00633c5-5479-41b2-b188-89d2a9922924', '3.c', 'Get some Lawyers to cross-examine witnesses in a non-hostile fashion', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'44089923-7367-4e97-82c3-dfe6b270d493'),
  (N'dbe26c4f-7f92-451a-a9b5-8e43fc9cd6c9', 'EF 4', 'Force Gen (Training)', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'c098a5b3-8d80-429d-ada2-fd57dc331e2a', '4.a', 'Get a website for people to apply on', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'dbe26c4f-7f92-451a-a9b5-8e43fc9cd6c9'),
  (N'eddf19f6-f6e1-44f5-9093-f3e2ade59428', '4.b', 'Hire People', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'dbe26c4f-7f92-451a-a9b5-8e43fc9cd6c9'),
  (N'0cb03167-2772-4d3e-8382-5870da58022a', '4.b.1', 'Get an HR team', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'eddf19f6-f6e1-44f5-9093-f3e2ade59428'),
  (N'df8fd269-b382-486e-9bc6-f3f4b77a03b0', '4.b.2', 'Review resumes for hiring', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'eddf19f6-f6e1-44f5-9093-f3e2ade59428'),
  (N'17f35bc6-a0f3-4f79-8813-2176a7d7ca2f', '4.b.3', 'Invite people to come interview', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'eddf19f6-f6e1-44f5-9093-f3e2ade59428'),
  (N'32788f96-b72c-4314-8286-7f59b683cba2', '4.b.4', 'Interview candidates', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'eddf19f6-f6e1-44f5-9093-f3e2ade59428'),
  (N'cca1678a-58d7-4213-9c67-f894879df776', '4.b.5', 'Extend Job Offers to successful candidates', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'eddf19f6-f6e1-44f5-9093-f3e2ade59428'),
  (N'98342fa0-9106-4ef1-bc47-e4af2f5da330', '4.c', 'Onboard new Employees', 0, TRUE, 'Milestone', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'dbe26c4f-7f92-451a-a9b5-8e43fc9cd6c9'),
  (N'242efaa3-d5de-4970-996d-50ca90ef6480', 'EF 5', 'Force Sustainment (Logistics)', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'12b8dbcc-8f31-444a-9437-00fe00fc1f7b', 'EF6', 'C2 Operations', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'19364d81-3203-483d-a6bf-461d58888c76', 'EF7', 'Intelligence', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'9b9f4205-0721-4893-abf8-69e020d4db23', 'EF8', 'Stratcom', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'4831e09b-2bbb-4717-9bfa-91071e62260a', 'EF9', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (N'5173f34b-16f5-4e18-aa3d-def55c40e36d', 'Gender', '', 0, TRUE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'4831e09b-2bbb-4717-9bfa-91071e62260a'),
  (N'073da176-8129-4d9b-afa3-416edde6846a', 'TAAC', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (uuid_generate_v4(), 'TAAC-N', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'073da176-8129-4d9b-afa3-416edde6846a'),
  (uuid_generate_v4(), 'TAAC-S', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'073da176-8129-4d9b-afa3-416edde6846a'),
  (uuid_generate_v4(), 'TAAC-E', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'073da176-8129-4d9b-afa3-416edde6846a'),
  (uuid_generate_v4(), 'TAAC-W', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'073da176-8129-4d9b-afa3-416edde6846a'),
  (uuid_generate_v4(), 'TAAC-C', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'073da176-8129-4d9b-afa3-416edde6846a'),
  ('d5383bff-abfe-4e2f-89b1-f937e9eface9', 'TAAC Air', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, N'073da176-8129-4d9b-afa3-416edde6846a'),
  ('826f43ea-9f0a-40c4-87cb-70aba83bf044', 'Factors', 'Factors', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('ec49de46-dd69-48c9-bde1-ecc69fa3befe', 'Factor1', 'Factor1', 0, TRUE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '826f43ea-9f0a-40c4-87cb-70aba83bf044'),
  ('f07beca6-153e-49da-8aaa-3e29c2a1f4bc', 'Domains', 'Domains', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('4ac816ec-f379-4399-875c-67a9ec27d41b', 'Domain1', 'Domain1', 0, TRUE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'f07beca6-153e-49da-8aaa-3e29c2a1f4bc'),
  ('483051a0-55e8-45e1-99dc-384be317112f', 'Topics', 'Topics', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('e1b614a0-d6a7-4300-9f0f-f9fcc245c04f', 'Topic1', 'Topic1', 0, TRUE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '483051a0-55e8-45e1-99dc-384be317112f'),
  ('0baf4493-7fd8-423a-8ba3-43e8386d11a7', 'Test 1', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('33c87d55-9f90-4a23-903a-f7d176444de3', 'Test 1.1', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '0baf4493-7fd8-423a-8ba3-43e8386d11a7'),
  ('36d8b14c-40b2-4bbe-9d15-9b964381f549', 'Test 1.1.1', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '33c87d55-9f90-4a23-903a-f7d176444de3'),
  ('c38c7c84-66cc-4978-9cf6-b07d10a50667', 'Test 1.1.1.1', '', 0, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '36d8b14c-40b2-4bbe-9d15-9b964381f549'),
  ('d664b2d9-0038-4130-9bfd-2d27c8b6cb30', 'Test 2', '', 1, FALSE, 'EF', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
...
INSERT INTO organizations (uuid, "shortName", "longName", "identificationCode", "parentOrgUuid", "locationUuid", app6context, "app6standardIdentity", "app6symbolSet", "app6hq", "app6amplifier", "app6entity", "app6entityType", "app6entitySubtype", "app6sectorOneModifier",  "app6sectorTwoModifier", "createdAt", "updatedAt") VALUES
  ('381d5435-8852-45d2-91b1-530560ca9d8c', 'Merge Org 1', 'Long Merge 1 Name', 'Mg1', (SELECT uuid FROM organizations WHERE "shortName" = 'EF 1'), 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', '0', '4', '15', '2', '31', '11', '01', '03', '01', '00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('e706f443-7d4d-4356-82bc-1456f55e3d75', 'Merge Org 2', 'Long Merge 2 Name', 'Mg2', (SELECT uuid FROM organizations WHERE "shortName" = 'EF 1'), '95446f93-249b-4aa9-b98a-7bd2c4680718', '2', '2', '10', '5', '11', '20', '05', '00', '20', '42', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'Cost Adder - MoD'), '90fa5784-9e63-4353-8119-357bcd88e287', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = '90fa5784-9e63-4353-8119-357bcd88e287' WHERE name = 'Cost Adder - MoD';
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'Chief of Police'), '6866ce4d-1f8c-4f78-bdc2-4767e9a859b0', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = '6866ce4d-1f8c-4f78-bdc2-4767e9a859b0' WHERE name = 'Chief of Police';
INSERT INTO "positionRelationships" ("positionUuid_a", "positionUuid_b", "createdAt", "updatedAt", deleted) VALUES
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'Planning Captain'), '237e8bf7-2ae4-4d49-b7c8-eca6a92d4767', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = '237e8bf7-2ae4-4d49-b7c8-eca6a92d4767' WHERE name = 'Planning Captain';
INSERT INTO "positionRelationships" ("positionUuid_a", "positionUuid_b", "createdAt", "updatedAt", deleted) VALUES
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'Chief of Tests'), '5fa54ffd-cc90-493a-b4b1-73e9c4568177', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = '5fa54ffd-cc90-493a-b4b1-73e9c4568177' WHERE name = 'Chief of Tests';
INSERT INTO "positionRelationships" ("positionUuid_a", "positionUuid_b", "createdAt", "updatedAt", deleted) VALUES
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'Director of Tests'), '0c5a8ba7-7436-47fd-bead-b8393246a300', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = '0c5a8ba7-7436-47fd-bead-b8393246a300' WHERE name = 'Director of Tests';
INSERT INTO "positionRelationships" ("positionUuid_a", "positionUuid_b", "createdAt", "updatedAt", deleted) VALUES
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt") VALUES
  ((SELECT uuid from positions where name = 'Merge One'), 'cebeb179-2a64-4d0c-a06b-76e68f80b5e5', '2020-01-01');
UPDATE positions SET "currentPersonUuid" = 'cebeb179-2a64-4d0c-a06b-76e68f80b5e5' WHERE name = 'Merge One';
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '9bb1861c-1f55-4a1b-bd3d-3c1f56d739b5', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "keyOutcomes", "nextSteps", state, "engagementDate", duration, atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '86e4cf7e-c0ae-4bd9-b1ad-f2c65ca0f600', TRUE, FALSE, TRUE),
  ('6866ce4d-1f8c-4f78-bdc2-4767e9a859b0', '86e4cf7e-c0ae-4bd9-b1ad-f2c65ca0f600', FALSE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "keyOutcomes", "nextSteps", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '3e717721-d675-4ff3-b687-533b50978f9e', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "keyOutcomes", "nextSteps", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '5d11abd0-242b-41ef-8420-a931d19ee513', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", state, "releasedAt", "engagementDate", atmosphere, "atmosphereDetails", "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', 'ee0fc732-e6ed-4c53-9d74-a8ac1d8f3ccd', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "keyOutcomes", "nextSteps", state, "releasedAt", "engagementDate", atmosphere, "atmosphereDetails", "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('6866ce4d-1f8c-4f78-bdc2-4767e9a859b0', 'c9884c73-31c5-441e-ad6b-350513e28b84', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '5f681376-6eac-464d-8d46-02ff89d45071', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '5367a91a-9f70-469d-b0a4-69990ea8ac82', TRUE, FALSE, TRUE),
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('6866ce4d-1f8c-4f78-bdc2-4767e9a859b0', '3e0ef6c9-68ed-43cf-8beb-d24c1c59c7a5', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 1.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('6866ce4d-1f8c-4f78-bdc2-4767e9a859b0', 'e5319bc4-91f2-473b-92c7-e796bc84b169', TRUE, FALSE, TRUE),
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('237e8bf7-2ae4-4d49-b7c8-eca6a92d4767', 'a766b3f1-4705-43c1-b62a-ca4e3bb4dce3', TRUE, FALSE, TRUE),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", "keyOutcomes", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.2'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('237e8bf7-2ae4-4d49-b7c8-eca6a92d4767', '91cac8ff-dca5-4cf5-bf2c-dd72aa3685f8', TRUE, FALSE, TRUE),
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('237e8bf7-2ae4-4d49-b7c8-eca6a92d4767', '3fa48376-0519-48ba-8d91-2fa18c7a040f', TRUE, FALSE, TRUE),
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ...
  ('f73f5cc9-69fd-4ceb-81b9-a0a840914bd8', '59be259b-30b9-4d04-9e21-e8ceb58cbe9c', TRUE, FALSE, TRUE),
  ('02fdbd68-866f-457a-990c-fbd79bc9b96c', '59be259b-30b9-4d04-9e21-e8ceb58cbe9c', FALSE, FALSE, FALSE),
  ('0c5a8ba7-7436-47fd-bead-b8393246a300', '59be259b-30b9-4d04-9e21-e8ceb58cbe9c', FALSE, FALSE, TRUE),
  ('5fa54ffd-cc90-493a-b4b1-73e9c4568177', '59be259b-30b9-4d04-9e21-e8ceb58cbe9c', FALSE, FALSE, TRUE);
INSERT INTO "reportTasks" ("taskUuid", "reportUuid") VALUES
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ...
  ('f73f5cc9-69fd-4ceb-81b9-a0a840914bd8', 'c3008f90-6a27-4343-b278-827a0a0dc6bf', TRUE, FALSE, TRUE),
  ('02fdbd68-866f-457a-990c-fbd79bc9b96c', 'c3008f90-6a27-4343-b278-827a0a0dc6bf', FALSE, FALSE, FALSE),
  ('0c5a8ba7-7436-47fd-bead-b8393246a300', 'c3008f90-6a27-4343-b278-827a0a0dc6bf', FALSE, FALSE, TRUE),
  ('5fa54ffd-cc90-493a-b4b1-73e9c4568177', 'c3008f90-6a27-4343-b278-827a0a0dc6bf', FALSE, FALSE, TRUE);
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ...
  ('f73f5cc9-69fd-4ceb-81b9-a0a840914bd8', 'bb9dad1a-1c6c-45de-91e8-aecda261d21e', TRUE, FALSE, TRUE);
INSERT INTO "reportTasks" ("taskUuid", "reportUuid") VALUES
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('237e8bf7-2ae4-4d49-b7c8-eca6a92d4767', '530b735e-1134-4daa-9e87-4491c888a4f7', TRUE, FALSE, TRUE),
...
INSERT INTO PEOPLE (uuid, "familyName", status, "createdAt", "updatedAt")
  SELECT 'a163cd6f-98ac-4a61-896c-9444dd1293af', 'ANET Importer', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  WHERE NOT EXISTS (SELECT uuid FROM people WHERE "familyName" = 'ANET Importer');

-- Tag some reports
INSERT INTO notes (uuid, "authorUuid", text, "createdAt", "updatedAt") VALUES
  ('0daa2cc7-29a3-4884-bb3a-1659d8a3962d', (SELECT uuid FROM people WHERE "familyName" = 'ANET Importer'),
...
INSERT INTO notes (uuid, "authorUuid", text, "createdAt", "updatedAt") VALUES
  ('7adbc0d1-780d-4aeb-810e-6439d55373b3', (SELECT uuid FROM people WHERE "familyName" = 'ANET Importer'),
...
INSERT INTO notes (uuid, "authorUuid", text, "createdAt", "updatedAt") VALUES
  ('01463629-8670-475f-9e0a-a1bf594f9eda', (SELECT uuid FROM people WHERE "familyName" = 'ANET Importer'),
...
INSERT INTO notes (uuid, "authorUuid", text, "createdAt", "updatedAt") VALUES
  ('a6074894-4ad7-4aa4-ab0c-f9b4b2701a1a', (SELECT uuid FROM people WHERE "familyName" = 'ANET Importer'),
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", state, "releasedAt", "engagementDate", atmosphere, "advisorOrganizationUuid", "interlocutorOrganizationUuid") VALUES
  ...
  (SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor", "isInterlocutor") VALUES
  ('90fa5784-9e63-4353-8119-357bcd88e287', '8655bf58-4452-4ac0-9221-70b035d8eb7e', TRUE, FALSE, TRUE),
...
INSERT INTO "assessmentRelatedObjects" ("assessmentUuid", "relatedObjectType", "relatedObjectUuid") VALUES
   ('16942947-41c2-478c-93bd-aaf7192a0e77', 'people', '237e8bf7-2ae4-4d49-b7c8-eca6a92d4767');
...
INSERT INTO "assessmentRelatedObjects" ("assessmentUuid", "relatedObjectType", "relatedObjectUuid") VALUES
  ('252c76e3-979a-4e47-9fde-4683de7556e8', 'people', '237e8bf7-2ae4-4d49-b7c8-eca6a92d4767');
...
INSERT INTO "assessmentRelatedObjects" ("assessmentUuid", "relatedObjectType", "relatedObjectUuid") VALUES
  ('e910f029-8aef-4440-a870-2711b2d8ffc9', 'people', '237e8bf7-2ae4-4d49-b7c8-eca6a92d4767');
...
INSERT INTO "assessmentRelatedObjects" ("assessmentUuid", "relatedObjectType", "relatedObjectUuid") VALUES
  ('995d37c0-1838-4405-996c-6a70ec3e9760', 'people', '6866ce4d-1f8c-4f78-bdc2-4767e9a859b0');
...
INSERT INTO "assessmentRelatedObjects" ("assessmentUuid", "relatedObjectType", "relatedObjectUuid") VALUES
  ('4af97017-617d-41ee-93cf-4ab92ef15902', 'people', '6866ce4d-1f8c-4f78-bdc2-4767e9a859b0');
...
INSERT INTO "eventTasks" ("eventUuid", "taskUuid") VALUES
  ('7cb0fc5d-74d0-4deb-86dd-7c84761b8ac6', '9d3da7f4-8266-47af-b518-995f587250c9'),
  ('46963161-53c1-4eab-85bb-d46a03d152c4', '9d3da7f4-8266-47af-b518-995f587250c9'),
  ('426a8f59-98de-48eb-9e5c-bbc774f1e35f', '9d3da7f4-8266-47af-b518-995f587250c9'),
  ('d7c96ce1-c785-4207-abb7-20935c9a2371', '9d3da7f4-8266-47af-b518-995f587250c9'),
...
INSERT INTO "peoplePositions" ("personUuid", "positionUuid", "createdAt", "primary") VALUES
